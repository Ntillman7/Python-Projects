...
def load_gui(self):
    ...
    self.lblDisplay.grid(row=13, column=1, padx=(30, 0), pady=(30, 0))
    ...
    self.btnSubmit = Button(self.master, text="Submit", width=10, height=2, command=lambda: tracking_func.submit(self))
    self.btnSubmit.grid(row=11,column=1, padx=(30, 0), pady=(30, 0), sticky=NE)

    self.btn_delete = tk.Button(self.master,width=12,height=2,text='Delete',command=lambda: tracking_func.onDelete(self))
    self.btn_delete.grid(row=11,column=2,padx=(30,0),pady=(30,0),sticky=W)
