...
class Account(models.Model):
    ...
    # Allows references to a specific account be returned as the owner's name is not the primary key
    def __str__(self):
...
class Transaction(models.Model):
    ...
    # The ON DELETE CASCADE is an option when defining a foreign key in SQL.
    # It indicates that related rows should be deleted in the child table when
