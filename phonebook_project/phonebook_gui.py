...
def load_gui(self):
    #define the default tkinter widgets and configuration using the grid geometry
    ...
    #bind = bound event,configuring an event handler (python function) that is called when an event occurs to a widget
...
if __name__ == "__main__":
    pass
    #because main will be the only module running things
